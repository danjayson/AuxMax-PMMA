...
public class PistonPump : MonoBehaviour {
	...
	Animator _Animator;
	bool expand, bool_comvalve, bool_shaft;
	...
	void Update () {
		...
		_Animator.SetBool ("PPComValve", bool_comvalve);
		_Animator.SetBool ("PPShaft", bool_shaft);
	}
	...
	public void Expand(){
		expand = true;
		//============== Main 3 Parts ===================
		if (_glowObject._Text.text == "Pressure Compensator Valve") {
			bool_comvalve = true;
