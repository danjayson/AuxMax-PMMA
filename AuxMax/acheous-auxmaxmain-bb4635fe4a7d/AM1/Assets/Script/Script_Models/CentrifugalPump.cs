...
public class CentrifugalPump : MonoBehaviour {
	...
	Animator _Animator;
	bool expand, bool_casing, bool_shaft;
	...
	void Update () {
		...
		_Animator.SetBool ("CasingExpand", bool_casing);
	...
	public void Expand(){
		expand = true;
		//============== Main 3 Parts ===================
		if (_glowObject._Text.text == "Casing") {
			bool_casing = true;
